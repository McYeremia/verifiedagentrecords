                ...
                >
                  <div className="flex items-center gap-3.5 mb-4">
                    <div
                      ...
                      style={{ width: 44, height: 44, background: "rgba(59, 130, 246, 0.12)", fontSize: 22 }}
                    >
                      🏆
                    </div>
                    <div>
                  ...
                  <div
                    className="grid grid-cols-2 gap-1 pt-4 border-t border-white/5"
                  >
                ...
                >
                  ...
                  {entries.map((entry, i) => (
                    ...
                    >
                      ...
                      {/* Correct */}
                      <div className="text-[13px] font-semibold text-[#1D9E75]">
                        {entry.correct}
                      </div>
