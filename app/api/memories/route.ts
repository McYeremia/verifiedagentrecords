...
//
// [RESULT] records are now surfaced inside recallUserMemoriesDetailed itself (a
// dedicated RESULT-focused recall merged into the shared cache), so this endpoint
// no longer needs its own secondary recall — the shared result set is complete.
